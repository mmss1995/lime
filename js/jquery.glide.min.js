(function(f, e, b, h) {
	...
	a.prototype.navigation = function() {
		...
		if(j.slides.length > 1) {
			var q = j.options, n = (j.options.nav === true) ? j.parent : j.options.nav;
			j.navWrapper = f("<div />", {
				"class" : q.navClass
			}).appendTo(n);
			var p = j.navWrapper, l;
	...
	a.prototype.arrows = function() {
		var j = this;
		if(j.slides.length > 1) {
			var l = j.options, k = (j.options.arrows === true) ? j.parent : j.options.arrows;
	...
	a.prototype.slide = function(j, q, p) {
		var o = this, l = (q) ? 0 : o.currentSlide, m = -(o.slides.length - 1), n = o.options.navCurrentItemClass, i = o.slides.spread;
		o.pause();
		if(l === 0 && j === -1) {
			l = m
		} else {
		...
		o.currentSlide = l;
		if((p !== "undefined") && ( typeof p === "function")) {p()
		}
		o.play()
	};
	...
	a.prototype.swipe = function() {
		var u = this, q, o, k, j, r, p, v, w, l, s = 180 / Math.PI, t, i, n, m;
	...
	function c(o) {
		var j = false, l = "Khtml Ms O Moz Webkit".split(" "), n = b.createElement("div"), m = null;
		o = o.toLowerCase();
		if(n.style[o]) {
			j = true
		}
